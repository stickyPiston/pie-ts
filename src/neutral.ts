...
export class TransLeft extends Neutral {
    public constructor(public left: Neutral, public right: Normal) {
        super();
    }
...
export class TransRight extends Neutral {
    public constructor(public left: Normal, public right: Neutral) {
        super();
    }
...
export class TransLeftRight extends Neutral {
    public constructor(public left: Neutral, public right: Neutral) {
        super();
    }
...
export class Cong extends Neutral {
    public constructor(public target: Neutral, public func: Normal) {
        super();
    }
    public override read_back(context: V.Rho): C.Core {
...
export class Symm extends Neutral {
    public constructor(public equality: Neutral) {
        super();
    }
    public override read_back(context: V.Rho): C.Core {
...
export class Head extends Neutral {
    public constructor(public target: Neutral) {
        super();
    }
    public override read_back(context: V.Rho): C.Core {
...
interface HasReadBack {
    read_back(context: V.Rho): C.Core;
}
function read_back_indVec(
    this: {
        ell: HasReadBack;
        target: HasReadBack;
        motive: HasReadBack;
